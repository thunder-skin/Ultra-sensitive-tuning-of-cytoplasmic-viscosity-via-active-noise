...
d=plot(data(:,5)*xx,data(:,2)*yy1,"o","Marker","x","MarkerSize",15,"MarkerFaceColor",color(2,:),"Color",color(2,:),"LineWidth",2); 
...
y_test=log10(data(:,6)*yy1);

x_i=linspace(-0.5,3.8,40)
y_fit=csaps(x_test,y_test,0.9,x_i)
