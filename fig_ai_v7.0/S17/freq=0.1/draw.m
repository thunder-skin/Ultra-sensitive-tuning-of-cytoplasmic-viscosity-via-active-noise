...
%jamming以下描点
plot(data(:,12),data(:,8),"o","Color",color(6,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(6,:));
plot(data(:,13),data(:,9),"o","Color",color(7,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(7,:));
plot(data(:,14),data(:,10),"o","Color",color(8,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(8,:));

%jamming以上描点
plot(data(:,1),data(:,3),"o","Color",color(1,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(1,:));
...
plot(data(:,11),data(:,6),"o","Color",color(4,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(4,:));
plot(data(:,11),data(:,7),"o","Color",color(5,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(5,:));


%jamming以下连线拟合
x_test=log10(data(:,12));
y_test=log10(data(:,8));
xi=linspace(2,6.5,100);
