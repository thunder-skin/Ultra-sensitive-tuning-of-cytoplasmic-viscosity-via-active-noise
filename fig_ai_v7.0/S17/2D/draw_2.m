...
plot(data(:,11),data(:,2),"x","Color",color(9,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(9,:));
plot(data(:,12),data(:,3),"x","Color",color(8,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(8,:));
