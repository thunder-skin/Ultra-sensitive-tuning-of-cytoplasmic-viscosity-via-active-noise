...
l=legend([b,a,c,d,e], ...
    'ATP-depleted Cell (Ebata $$\textit{et al.}$$)','Live Cell (Ebata $$\textit{et al.}$$)','Live Cell (Muenker $$\textit{et al.}$$)','$$kT_{\rm{eff}}=3.2 \times 10^{-5}$$ (Simulation)','$$kT_{\rm{eff}}=2.5 \times 10^{-4}$$ (Simulation)','Interpreter', 'latex');
set(l, 'box', 'off')
