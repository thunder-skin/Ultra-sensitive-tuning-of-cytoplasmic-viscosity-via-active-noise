...
c=plot(data(:,1)*xx,data(:,3)*yy-p1,"o","Marker","x","MarkerSize",15,"MarkerFaceColor",color(5,:),"Color",color(5,:),"LineWidth",2); 
...
y_test=log10(data(:,3)*yy*0.95-p1);
...
str="$$\mathrm{Dissipation\ Modulus}\ G''\ (\mathrm{Pa})$$";
