...
c=plot(data(:,1),data(:,3)*0.95-p1,"o","Marker","x","MarkerSize",15,"MarkerFaceColor",color(5,:),"Color",color(5,:),"LineWidth",2); 
data=xlsread("data_7.xlsx")
d=plot(data(:,1),data(:,3)-p2,"o","Marker","x","MarkerSize",15,"MarkerFaceColor",color(2,:),"Color",color(2,:),"LineWidth",2);
