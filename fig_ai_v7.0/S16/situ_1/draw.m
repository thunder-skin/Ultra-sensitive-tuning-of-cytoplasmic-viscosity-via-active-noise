...
%jamming以上描点
plot(data(:,7),data(:,8),"o","Color",color(1,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(1,:));
plot(data(:,9),data(:,10),"o","Color",color(2,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(2,:));
plot(data(:,11),data(:,12),"o","Color",color(3,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(3,:));
plot(data(:,13),data(:,14),"o","Color",color(4,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(4,:));
plot(data(:,15),data(:,16),"o","Color",color(5,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(5,:));
plot(data(:,17),data(:,18),"o","Color",color(6,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(6,:));
plot(data(:,19),data(:,20),"o","Color",color(7,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(7,:));

%jamming以下连线拟合
x_test=log10(data(:,1));
y_test=log10(data(:,2));
xi=linspace(-1.5,2.9,100);
...
b8=plot(xi,yi,"--","Color",color(5,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(1,:));
b9=plot(xi,yi,"--","Color",color(6,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(2,:));
b10=plot(xi,yi,"--","Color",color(7,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(3,:));
...
l=legend([b8,b9,b10,b1,b2,b3,b4,b5,b6,b7],"$$0.650$$","$$0.660$$","$$0.665$$","$$0.670$$","$$0.680$$","$$0.690$$","$$0.700$$","$$0.710$$","$$0.720$$","$$0.730$$",'Interpreter', 'latex');
set(l, 'Box', 'off')
