...
%jamming以下描点
plot(data(:,1),data(:,2),"o","Color",color(4,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(4,:));
plot(data(:,3),data(:,4),"o","Color",color(5,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(5,:));
plot(data(:,5),data(:,6),"o","Color",color(6,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(6,:));
plot(data(:,7),data(:,8),"o","Color",color(7,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(7,:));
...
b8=plot(xi,yi,"--","Color",color(4,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(4,:));
b9=plot(xi,yi,"--","Color",color(5,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(5,:));
b10=plot(xi,yi,"--","Color",color(6,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(6,:));
b11=plot(xi,yi,"--","Color",color(7,:),"LineWidth",line_width,"Marker","+","MarkerSize",marker_size,"MarkerFaceColor",color(7,:));
...
l=legend([b8,b9,b10,b11,b1,b2,b3,b4,b5,b6,b7],"$$0.630$$","$$0.640$$","$$0.645$$","$$0.650$$","$$0.660$$","$$0.670$$","$$0.680$$","$$0.690$$","$$0.700$$","$$0.710$$","$$0.720$$",'Interpreter', 'latex');
set(l, 'Box', 'off')
