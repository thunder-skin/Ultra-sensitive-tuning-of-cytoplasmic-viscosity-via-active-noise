...
plot(data(:,13),data(:,4),"o","Color",color(7,:),"LineWidth",line_width,"Marker","x","MarkerSize",marker_size,"MarkerFaceColor",color(7,:));
...
x_test=log10(data(:,1));
y_test=log10(data(:,15));
xi=linspace(-1.5,6.1,100);
yi=csaps(x_test,y_test,0.9,xi);
...
aa=3;
plot([1e4,10^5.5],[10.^(-1),10.^(-1.72)]*aa,"--","Color","k","LineWidth",line_width*1.5)
