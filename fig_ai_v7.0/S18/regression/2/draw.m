...
c=plot(data(:,1)*xx,data(:,3)*yy*qq-p1,"o","Marker","x","MarkerSize",15,"MarkerFaceColor",color(5,:),"Color",color(5,:),"LineWidth",2); 
data=xlsread("data_7.xlsx")
d=plot(data(:,1)*xx,data(:,3)*yy-p2,"o","Marker","x","MarkerSize",15,"MarkerFaceColor",color(2,:),"Color",color(2,:),"LineWidth",2);
